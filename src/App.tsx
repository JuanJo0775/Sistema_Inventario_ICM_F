    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path="/app/inventory"
          element={
            <ProtectedRoute allowedRoles={['almacenista', 'auxiliar_despacho', 'administrador']}>
              <InventoryPage />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          path="/app/dispatch"
          element={
            <ProtectedRoute allowedRoles={['auxiliar_despacho', 'almacenista']}>
              <DispatchPage />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute allowedRoles={['almacenista', 'auxiliar_despacho']}>
              <TransfersPage />
            </ProtectedRoute>
          }
        />
